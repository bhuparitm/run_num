...
<body class="hold-transition  sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="./report_secret2.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon" style="color: aqua;"></i>
                                    <p>เรื่องลับมาก</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <center>
                <button class="btn btn-secondary btn-sm" style="width: 250px; font-size:25px" onclick="window.open('print.php?type=secret2&year='+$('.years').val())" target="popup">Print</button>
            </center>
            <br><br>
        </section>
        <!-- /.content -->
...
<script>
    ...
    function edit(id) {
        window.location.href = "frm_book.php?type=secret2&id=" + id;
    }
    ...
    function del(id, num_doc) {
        Swal.fire({
            ...
            if (result.value) {
                $.get('report_del.php?type=secret2&id=' + id, function(res) {
                    if (res == '0') {
