...
<body class="hold-transition  sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table id="tbreport" class="display" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th>ถึง</th>
                        <th>เรื่อง</th>
                        <th>รายละเอียดความลับ</th>
                        <th>ชื่อผู้ให้เหตุผล</th>
                        <th>ตำแหน่ง</th>
                        <th>ผู้ลงนาม</th>
                        <th>ผู้ขอ</th>
                        <th>หมายเหตุ</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            ?>
                                <td>
                                    <button type="button" class="btn btn-info btn-sm btn-edit" data-id="<?= $tb['id']; ?>" data-num_doc="<?= $tb['num_doc']; ?>">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm btn-del" data-id="<?= $tb['id']; ?>" data-num_doc="<?= $tb['num_doc']; ?>">
            ...
            <button class="btn btn-primary" onclick="window.open('print.php?type=secret1&year='+$('.years').val())" target="popup">Print</button>
            <br><br>
        </section>
        <!-- /.content -->
    </div>
...
<script>
    $(function() {
        ...
        $('.btn-del').click(function() {
            ...
            var num_doc = $(this).attr('data-num_doc');
            Swal.fire({
                text: "คุณต้องการหนังสือปกติเลขที่ " + num_doc,
                icon: "warning",
